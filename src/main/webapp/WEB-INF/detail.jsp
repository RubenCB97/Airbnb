      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="column">
            ...
            <p>
              Preciosa Villa con Piscina Privada. Vista despejada de montañas,
              valles y mar. Acogedora y confortable villa "Clementina", 2
              plantas. Monte Pego, posición elevada, a 8 km del mar. Para uso
              privado: jardín natural, piscina en forma de riñón (8 x 4 m).
              Plaza de aparcamiento en el suelo. Supermercado 6 km, restaurante
              2 km, playa de arena 8 km. Campo de golf a 12 km, tenis a 5 km.
            </p>
            ...
            <select required name="Categoria" class="form-control">
              ...
              <option value="Categoria3">Categoria3</option></select
            ><br />
            <p>
              Servicios:
              <input type="checkbox" name="Servicios" value="Servicios" />
            </p>
            <p>
